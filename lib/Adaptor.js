...
function fetchSurveyData(params) {
  ...
  return function (state) {
    ...
    // const body = "username=taylordowns2000&accesstoken=2ea766a28f9148f7b122cd0451c2c50c&surveyid=37479"

    // const url = "http://requestb.in/1ih788e1"
    // const body = `username=${username}&accesstoken=${accessToken}&surveyid=${formId}`
    var form = {
      username: username,
